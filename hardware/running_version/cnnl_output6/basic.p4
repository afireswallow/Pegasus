        ...
        inout ingress_intrinsic_metadata_for_tm_t ig_tm_md) 
{
    ...
    action set_x4_1(bit<32> in01, bit<32> in02, bit<32> in03, bit<32> in04, bit<32> in05, bit<32> in06) {
        hdr.output.linear1.l32_1 = in01;
        hdr.output.linear1.l32_2 = in02;
        hdr.output.linear1.l32_3 = in03;
        hdr.output.linear1.l32_4 = in04;
        hdr.output.linear1.l32_5 = in05;
        hdr.output.linear1.l32_6 = in06;
        //hdr.output.linear1.l32_7 = in07;
    }
    action set_x4_2(bit<32> in01, bit<32> in02, bit<32> in03, bit<32> in04, bit<32> in05, bit<32> in06) {
    ...
    action set_x4_3(bit<32> in01, bit<32> in02, bit<32> in03, bit<32> in04, bit<32> in05, bit<32> in06) {
        ...
        hdr.output.linear1.l32_5 = in05 + hdr.output.linear1.l32_5;
        hdr.output.linear1.l32_6 = in06 + hdr.output.linear1.l32_6;
        //hdr.output.linear1.l32_7 = in07 + hdr.output.linear1.l32_7;
    }
    table x4_1 {
        key = {
            ig_md.temp.l4_1: exact;
    ...
    action copy_data() {
        ...
        // data_offset(4位) + res(4位) → 合成一个字节
        //ig_md.b_7.l8_1 = { hdr.tcp.data_offset, hdr.tcp.res };
    ...
    apply
    {
        ...
        if (hdr.tcp.isValid()) {
            // ig_md.interval = hdr.tcp.urgent_ptr;
...
//            ig_md.reg.l8_5[7:4] = ig_md.temp.l4_1;
//            ig_md.reg.l8_5[3:0] = 0;
//        }
//        else {
//            ig_md.reg.l8_5[7:4] = 0;
//            ig_md.reg.l8_5[3:0] = ig_md.temp.l4_1;
//        }
...
//        hdr.feature.b_1.l8_1 = ig_md.reg.l8_1;
//        hdr.feature.b_1.l8_2 = ig_md.reg.l8_2;
//        hdr.feature.b_2.l8_1 = ig_md.reg.l8_3;
//        hdr.feature.b_2.l8_2 = ig_md.reg.l8_4;
        ...
        hdr.output.linear1.l32_4 = ig_md.linear1.l32_4 + hdr.output.linear1.l32_4;
        hdr.output.linear1.l32_5 = ig_md.linear1.l32_5 + hdr.output.linear1.l32_5;
        hdr.output.linear1.l32_6 = ig_md.linear1.l32_6 + hdr.output.linear1.l32_6;
        //hdr.output.linear1.l32_7 = ig_md.linear1.l32_7 + hdr.output.linear1.l32_7;

        // hdr.tcp.window = hdr.output.linear1.l32_1[15:0];
        // hdr.tcp.checksum = hdr.output.linear1.l32_2[15:0];
        // ig_md.interval = hdr.output.linear1.l32_3[15:0];
