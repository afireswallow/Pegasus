...
current_dir = Path(__file__).parent
p4info_file_path = Path("../build/mlp_PeerRush.p4info.txt")
bmv2_json_path = Path("../build/mlp_PeerRush.json")
model_file_path = Path("../../make_dataset/mlp/PeerRush/mlp_PeerRush.pkl")
