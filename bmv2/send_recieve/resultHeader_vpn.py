...
class ResultHeader(Packet):
    ...
    fields_desc = [
        ...
        SignedIntField("l32_4", 0),
        SignedIntField("l32_5", 0),
        SignedIntField("l32_6", 0),
    ]
    def mysummary(self):
        return self.sprintf("l32_1=%l32_1%, l32_2=%l32_2%, l32_3=%l32_3%, l32_4=%l32_4%,l32_5=%l32_5%, l32_6=%l32_6%")
