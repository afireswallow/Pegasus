...
from resultHeader import ResultHeader, FeatureHeader , ReservedResultHeader, Label
...
def summary(pkt):
    ...
    # label0 = pkt[ResultHeader].l32_1
    # label1 = pkt[ResultHeader].l32_2
    # label2 = pkt[ResultHeader].l32_3
    ...
    if label2 > max :
        max = label2
        label = 2
    print("Predict label: {}, True label: {}".format(label, pkt[Label].label))
    ...
    return [
            ...
            label1,
            label2,
            padding_last_byte,  # Add padding last byte
            packet_last_byte   # Add packet last byte
            ]
