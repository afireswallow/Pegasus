...
// ****cal output
    ...
    action set_h2_1(bit<32> in01, bit<32> in02, bit<32> in03, bit<32> in04, bit<32> in05, bit<32> in06) {
        meta.linear2.l32_1 = in01;
        meta.linear2.l32_2 = in02;
        meta.linear2.l32_3 = in03;
        meta.linear2.l32_4 = in04;
        meta.linear2.l32_5 = in05;
        meta.linear2.l32_6 = in06;
    }
    
    action set_h2_2(bit<32> in01, bit<32> in02, bit<32> in03, bit<32> in04, bit<32> in05, bit<32> in06) {
    ...
    action set_h2_3(bit<32> in01, bit<32> in02, bit<32> in03, bit<32> in04, bit<32> in05, bit<32> in06) {
        ...
        meta.linear2.l32_5 = in05 + meta.linear2.l32_5;
        meta.linear2.l32_6 = in06 + meta.linear2.l32_6;
    }
    
    action set_h2_4(bit<32> in01, bit<32> in02, bit<32> in03, bit<32> in04, bit<32> in05, bit<32> in06) {
    ...
    action set_h2_5(bit<32> in01, bit<32> in02, bit<32> in03, bit<32> in04, bit<32> in05, bit<32> in06) {
        meta.linear2.l32_1 = in01 + meta.linear2.l32_1;
        meta.linear2.l32_2 = in02 + meta.linear2.l32_2;
        meta.linear2.l32_3 = in03 + meta.linear2.l32_3;
        meta.linear2.l32_4 = in04 + meta.linear2.l32_4;
    ...
    action set_h2_6(bit<32> in01, bit<32> in02, bit<32> in03, bit<32> in04, bit<32> in05, bit<32> in06) {
        hdr.output.linear1.l32_1 = in01 + hdr.output.linear1.l32_1;
        hdr.output.linear1.l32_2 = in02 + hdr.output.linear1.l32_2;
        hdr.output.linear1.l32_3 = in03 + hdr.output.linear1.l32_3;
        hdr.output.linear1.l32_4 = in04 + hdr.output.linear1.l32_4;
    ...
    action set_h2_7(bit<32> in01, bit<32> in02, bit<32> in03, bit<32> in04, bit<32> in05, bit<32> in06) {
        meta.linear2.l32_1 = in01 + meta.linear2.l32_1;
        meta.linear2.l32_2 = in02 + meta.linear2.l32_2;
        meta.linear2.l32_3 = in03 + meta.linear2.l32_3;
        meta.linear2.l32_4 = in04 + meta.linear2.l32_4;
    ...
    action set_h2_8(bit<32> in01, bit<32> in02, bit<32> in03, bit<32> in04, bit<32> in05, bit<32> in06) {
        hdr.output.linear1.l32_1 = in01 + hdr.output.linear1.l32_1;
        hdr.output.linear1.l32_2 = in02 + hdr.output.linear1.l32_2;
        hdr.output.linear1.l32_3 = in03 + hdr.output.linear1.l32_3;
        hdr.output.linear1.l32_4 = in04 + hdr.output.linear1.l32_4;
...
// *****cal output as linear3
        ...
        hdr.output.linear1.l32_5 = hdr.output.linear1.l32_5 + meta.linear2.l32_5;
        hdr.output.linear1.l32_6 = hdr.output.linear1.l32_6 + meta.linear2.l32_6;
